...
CREATE TABLE `Favoritos` (
    ...
    UNIQUE INDEX `Favoritos_usuarioId_key`(`usuarioId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `CarritosItems` ADD CONSTRAINT `CarritosItems_carritoId_fkey` FOREIGN KEY (`carritoId`) REFERENCES `Carritos`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
